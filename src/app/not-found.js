...
const NotFoundPage = () => {
    return (
        <div className="relative flex items-center justify-center min-h-screen bg-green-950 dark:bg-gray-900">
            <div className="w-[calc(100%-100px)] xl:w-[70%] mx-auto bg-white rounded-md shadow-md p-8 min-h-[400px] relative">
                <div className="flex flex-col gap-8 items-center">
                    <div className="px-4 text-7xl lg:text-[190px] text-green-900 font-extrabold tracking-wider">
                        404
                    </div>

                    <div className="ml-4 text-3xl lg:text-4xl text-black font-semibold tracking-wider">
                        Page not found
                    </div>
