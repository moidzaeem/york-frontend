...
const Page = () => {
    ...
    const handleCommentsPopup = (tenderID) => {
        setResourceID(tenderID);
    ...
    const handleUnarchivePopup = (tenderID) => {
        setResourceID(tenderID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/tenders" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/tenders?archive=true",
            ...
            render: (row) => {
                ...
                return (
                    <div 
                        ...
                        <div className="bg-[#13ad86] mt-4 px-5 py-2 rounded-full font-semibold capitalize text-base text-white md:text-base text-center" >
                            { row.status }
                        </div>
                        ...
                        <div className="w-full flex items-center justify-end">
                            <span className="w-max px-4 py-1 bg-white dark:bg-gray-800 text-gray-700 text-xs font-extrabold rounded-full">
    ...
    return (
        <>
            <title>YORK - Tenders Archives</title>
