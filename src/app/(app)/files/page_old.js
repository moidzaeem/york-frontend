...
const Page = () => {
    ...
    const actionButtons = (
        <>
            <BaseLink href="/files/archieves" className="bg-white md:bg-[#f5f5f5] text-xs md:text-base" >
                <Archieved className="fill-slate-500" />
                Archieves
            </BaseLink>
            <BaseLink href="/files/folders" className="bg-white md:bg-[#f5f5f5] text-xs md:text-base" >
                <SidebarFiles className="fill-slate-500" />
                Folders
            </BaseLink>
        </>
    );
