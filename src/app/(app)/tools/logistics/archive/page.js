...
const Page = () => {
    ...
    const handlePhotosPopup = (logisticID) => {
        setResourceID(logisticID);
    ...
    const handleCommentsPopup = (logisticID) => {
        setResourceID(logisticID);
    ...
    const handleDeletionPopup = (logisticID) => {
        setResourceID(logisticID);
    ...
    const handleUnarchivePopup = (logisticID) => {
        setResourceID(logisticID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/tools/logistics" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/logistics?archive=true",
                    ...
                    <div 
                        ...
                        <div
                            className="w-full flex items-center justify-between gap-2">
                                <span className="text-base text-gray-400 font-extrabold capitalize">Client</span>
                        </div>
                        <div
                        ...
                        <div className="flex flex-col gap-2 w-full mt-4">       
                            ...
                            <div className="w-full h-[30px] bg-white rounded-[15px] flex items-center justify-start gap-2 font-semibold text-sm">
                                <div className="rounded-[15px] bg-[#FE976F] text-white w-[132px] h-full flex items-center px-3">
                                    Project Type
                                </div>
                                <div className="grow text-[#939393] h-full flex items-center px-1">
                                    { row.project_type }
                        ...
                        <div className="w-full flex items-center justify-between gap-3">
                            <div className="w-full h-[30px] px-3 bg-white rounded-[15px] flex items-center justify-center gap-2 text-base">
                                Reg.Date: <span className="font-semibold">{ row.registration_date }</span>
                            </div>
                            <div className="w-full h-[30px] px-3 bg-white rounded-[15px] flex items-center justify-center gap-2 text-base">
                                Ship.Date: <span className="font-semibold">{ row.shipment_date }</span>
                            </div>
                        </div>
                    </div>
                );
    ...
    return (
        <>
            <title>YORK - Logistics Archive</title>
            ...
            <DeleteConfirmationModal 
                ...
                remoteEndPoint='/api/logistics/delete' 
            ...
            <ArchiveConfirmationModal 
                ...
                resourceID={resourceID} 
                remoteEndPoint='/api/logistics/archive' 
            ...
            <CommentsModal
                ...
                commentsEndpoint= "/api/logistics/comments"
                newCommentEndpoint= "/api/logistics/comment"
                resourceID={ resourceID }
                onClose={ closeCommentsModal } />

            <PhotosModal
                isVisible={ isPhotosModalVisible }
                photosEndpoint= "/api/logistics/files"
                newPhotoEndpoint= "/api/logistics/file"
                resourceID={ resourceID }
