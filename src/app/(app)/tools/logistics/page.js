...
const Page = () => {
    ...
    const handleArchivePopup = (logisticID) => {
        setResourceID(logisticID);
        ...
        <>
            {
                can("Logistics - Create") ? 
                    <BaseLink href="/tools/logistics/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            <BaseLink href="/tools/logistics/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                    ...
                    <div 
                        ...
                        <div
                            className="w-full flex items-center justify-between gap-2">
                                <span className="text-base text-gray-600 font-extrabold capitalize">Client</span>
                        </div>
                        <div
