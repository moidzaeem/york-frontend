...
const Page = () => {
    ...
    if (!can(["Categories - View", "Categories - Create", "Categories - Edit", "Categories - Delete"])) {
    ...
    const handleDeletionPopup = (categoryID) => {
        setResourceID(categoryID);
        ...
        <>
            {
                can("Categories - Create") ? 
                    <BaseLink href="/extras/inputs/categories/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        {
                            can("Categories - Edit") ? 
                                <SimpleIconLink href={`/extras/inputs/categories/${row.id}`} className="border border-gray-600" title="Edit">
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal 
                ...
                remoteEndPoint='/api/categories/delete' 
                onClose={closeModal}
