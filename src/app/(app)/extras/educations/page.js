...
const Page = () => {
    ...
    if (!can(["Education - View", "Education - Create", "Education - Edit", "Education - Delete"])) {
    ...
    const handleDeletionPopup = (learningMaterialID) => {
        setResourceID(learningMaterialID);
        ...
        <>
            {
                can("Education - Create") ? 
                    <BaseLink href="/extras/educations/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/learning_materials",
        ...
        columns: [
            ...
            },
            {
                label: "Resource",
                key: "path",
                field: "attachedResource.name",
                render: (data, row) => {
                    return <button onClick={() => { showFile(row.slug) }} className="text-sm text-blue-500 hover:underline" target="_blank">{row.name}</button>
                }
            },
            {
                label: "Date",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        {
                            can("Education - Edit") ? 
                                <SimpleIconLink href={`/extras/educations/${row.id}`} className="border border-gray-600" title="Edit">
                    ...
                    <div 
                        ...
                        <div
                            className="w-full flex items-center justify-between gap-2">
                                <span className="text-base text-gray-600 font-extrabold capitalize">Title</span>
                        </div>
                        <div
                        ...
                        <div
                            className="w-full flex items-center justify-between gap-2">
                                <span className="text-base text-gray-600 font-extrabold capitalize">Category</span>
                        </div>
                        <div
                            className="text-base text-[#202224] font-extrabold uppercase">
                                { row.category_name }
                        ...
                        <div
                            className="w-full flex items-center justify-between gap-2">
                                <span className="text-base text-gray-600 font-extrabold capitalize">Resource</span>
                        </div>
                        <div
                            className="text-base text-[#202224] font-extrabold uppercase">
                                <button onClick={() => { showFile(row.slug) }} className="text-sm text-blue-500 hover:underline" target="_blank">{row.name}</button>
                        </div>
    ...
    return (
        <>
            <title>YORK - Learning Materials</title>
            ...
            <DeleteConfirmationModal 
                ...
                remoteEndPoint='/api/learning_materials/delete' 
                onClose={closeModal}
