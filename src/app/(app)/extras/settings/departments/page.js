        ...
        <>
            {
                can("Departments - Create") ? 
                    <BaseLink href="/extras/settings/departments/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                    ...
                    return <ButtonGroupH>

                        {
                            can("Departments - Edit") ? 
                                <SimpleIconLink href={`/extras/settings/departments/${row.id}`} className="border border-gray-600" title="Edit">
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal 
                ...
                remoteEndPoint='/api/departments/delete' 
                onClose={closeModal}
