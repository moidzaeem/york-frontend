...
const Page = ({ params }) => {
    ...
    const {isSubmitted, submitData} = useSubmitData('/api/positions/update');
    ...
    const { initialData } = useFetchResource("/api/positions", params.id);
    ...
    const breadcrumb = (
        <ul className="flex items-center justify-start gap-3">
            ...
            <li >&gt;</li>
            <li className="capitalize text-base text-gray-800 font-bold hover:text-blue-500 hover:underline cursor-pointer" >
                <Link href="/extras/settings/departments">Positions</Link>
            </li>
            <li >&gt;</li>
    ...
    return (
        <>
            <title>YORK - Positions -- Edit</title>
                    ...
                    <form onSubmit={ can("Departments - Edit") ? formik.handleSubmit : () => false }>
...

                        {
                            can("Departments - Edit") ? 
                                <FormAction backUrl="/extras/settings/positions" isSubmitted={isSubmitted} />
                                :
                                ""
                        }
