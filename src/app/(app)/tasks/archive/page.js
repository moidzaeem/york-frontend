...
const Page = () => {
    ...
    const handleUnarchivePopup = (taskID) => {
        setResourceID(taskID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/tasks" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/tasks?archive=true",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        <SimpleIconButton className="border border-gray-600" onClick={ () => handleUnarchivePopup(row.id) } title="Unarchive">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                ...
                return (
                    <div 
                        ...
                        <div className="w-full flex items-center justify-end">
                            <span className="w-max px-4 py-1 bg-white dark:bg-gray-800 text-gray-400 text-base font-extrabold rounded-full">
    ...
    return (
        <>
            <title>YORK - Tasks Archive</title>
