...
const Page = () => {
    ...
    const actionButtons = (
        <>
            ...
            <BaseButton onClick={async () => { await exportToExcel("tasks", "pdf") }} className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                <Download className="fill-slate-500" />
                PDF
            </BaseButton>

            {can("Archive - Create") ? <BaseLink href="/tasks/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
