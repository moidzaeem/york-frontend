...
const Page = () => {
    ...
    const formik = useFormik({
        initialValues: {
            name: "",
            position_id: dropdowns?.positions?.length ? dropdowns?.positions[0].id : 0,
            department_id: dropdowns?.departments?.length ? dropdowns?.departments[0].id : 0,
            phone_number: "",
            email: "",
            employment_type: dropdowns?.employment_types?.length ? dropdowns?.employment_types[0] : "",
            dob: "",
            notes: "",
            address: "",
            password: "",
