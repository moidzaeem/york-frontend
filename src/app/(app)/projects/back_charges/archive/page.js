...
const Page = () => {
    ...
    const handleUnarchievePopup = (backChargeID) => {
        setResourceID(backChargeID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects/back_charges" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const breadcrumb = (
        <ul className="flex items-center justify-start gap-3">
            ...
            <li className="capitalize text-base text-gray-500 font-bold">
                Archived BackCharges
            </li>
        </ul>
    )

    const tableConfig = {
        remoteURL: "/api/back_charge?archive=true",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        <SimpleIconButton className="border border-gray-600" onClick={ () => handleUnarchievePopup(row.id) } title="Archive">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
    ...
    return (
        <>
            <title>YORK - Back Charge Archive</title>
