...
const Page = () => {
    ...
    if (!can(["BackCharges - View", "BackCharges - Create", "BackCharges - Edit", "BackCharges - Delete"])) {
    ...
    const handlePhotosPopup = (backChargeID) => {
        setResourceID(backChargeID);
    ...
    const handleCommentsPopup = (backChargeID) => {
        setResourceID(backChargeID);
    ...
    const handleDeletionPopup = (backChargeID) => {
        setResourceID(backChargeID);
    ...
    const handleArchievePopup = (backChargeID) => {
        setResourceID(backChargeID);
    ...
    const actionButtons = (
        <>
            {
                can("BackCharges - Create") ?
                    <BaseLink href="/projects/back_charges/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            <BaseButton onClick={async () => { await exportToExcel("BackCharges") }} className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                <Download className="fill-slate-500" />
                Download
            </BaseButton>

            {can("Archive - Create") ? <BaseLink href="/projects/back_charges/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                    ...
                    return <ButtonGroupH>
...

                        {
                            can("BackCharges - Edit") ?
                                <SimpleIconLink href={`/projects/back_charges/${row.id}`} className="border border-gray-600" title="Edit">
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                        ...
                        {can("Archive - Create") ? <SimpleIconButton className="border border-gray-600" onClick={() => handleArchievePopup(row.id)} title="Archive">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <ButtonGroupH>
                                ...
                                <SimpleIconButton className="border border-gray-600" onClick={() => handleArchievePopup(row.id)} title="Archive">
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-3">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                                    </svg>
                                </SimpleIconButton>
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal
                ...
                remoteEndPoint='/api/back_charge/delete'
            ...
            <ArchiveConfirmationModal
                ...
                resourceID={resourceID}
                remoteEndPoint='/api/back_charge/archive'
            ...
            <CommentsModal
                ...
                commentsEndpoint="/api/back_charge/comments"
                newCommentEndpoint="/api/back_charge/comment"
                resourceID={resourceID}
                onClose={closeCommentsModal} />

            <PhotosModal
                isVisible={isPhotosModalVisible}
                photosEndpoint="/api/back_charge/files"
                newPhotoEndpoint="/api/back_charge/file"
                resourceID={resourceID}
