        ...
        <>
            ...
            <Card className="h-auto min-h-96 md:rounded-[15px] bg-white md:bg-white px-0 md:px-4 dark:bg-transparent md:dark:bg-gray-800" >
                ...
                <div className="w-full px-4 mt-12">
                    <form onSubmit={ can("Projects - Edit") ? formik.handleSubmit : () => false}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-11 gap-y-6">
                            {/* Form Group start */}
                            <div className="">
                                <Label htmlFor="project_name">
                                    Project Name
                                    <InputError message={formik.touched.project_name && formik.errors.project_name ? formik.errors.project_name : ''} className="mt-2" />
                                </Label>
