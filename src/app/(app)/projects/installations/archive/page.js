...
const Page = () => {
    ...
    const handleUnarchivePopup = (installationID) => {
        setResourceID(installationID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects/installations" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/installations?archive=true",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        <SimpleIconButton className="border border-gray-600" onClick={ () => handleUnarchivePopup(row.id) } title="Archive">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
            ...
            render: (row) => {                
                ...
                return (
                    <div 
                        ...
                        <div
                            className="text-sm text-[#202224] font-medium uppercase">
                                Assigned To
                        </div>
                        <div
    ...
    return (
        <>
            <title>YORK - Installations Archive</title>
            ...
            <ArchiveConfirmationModal 
                ...
                datatableRef={datatableRef} >
                <h3>Are you sure to <strong>unarchive</strong> this resource?</h3>
            </ArchiveConfirmationModal>
