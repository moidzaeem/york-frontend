...
const Page = () => {
    ...
    if (!can(["Installations - View", "Installations - Create", "Installations - Edit", "Installations - Delete"])) {
    ...
    const handlePhotosPopup = (installationID) => {
    ...
    const handleCommentsPopup = (installationID) => {
        setResourceID(installationID);
    ...
    const handleDeletionPopup = (installationID) => {
        setResourceID(installationID);
    ...
    const handleArchivePopup = (installationID) => {
        setResourceID(installationID);
        ...
        <>
            {
                can("Installations - Create") ?
                    <BaseLink href="/projects/installations/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            <BaseButton onClick={async () => { await exportToExcel("installations") }} className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                <Download className="fill-slate-500" />
                Download
            </BaseButton>
            
          {  can("Archive - Create") ? <BaseLink href="/projects/installations/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        ...
        columns: [
            ...
            },
            {
                label: "Category",
                key: "category_name",
                field: "project.category.name"
            },
            {
                label: "Ins.Fee",
                key: "installation_amount",
                render: (data) => {
                    return data;
                }
            },
                    ...
                    return <ButtonGroupH>
...

                        {
                            (row.assignee_ids.includes(user.id) || user.role_name.includes('Manager') || user.role_name === 'Administrator') && (
                                ...
                                <SimpleIconLink href={`/projects/installations/${row.id}`} className="border border-gray-600" title="Edit">
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
            ...
            render: (row) => {
                ...
                return (
                    <div
                        ...
                        <div>
                            <div
                                className="w-full text-sm text-[#202224] font-medium uppercase">
                                Assigned To
                            </div>
                            <div
                                className="w-full mt-1 text-base text-[#202224] font-extrabold uppercase">
                                {row.assignee}
                            </div>
                        </div>
                        ...
                        <div className="w-full px-4 py-1  bg-[#2BB592] dark:bg-gray-800 text-slate-100 dark:text-slate-100 text-center text-base font-bold rounded-full">
                            {row.status}
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-3">
                            <span className="w-full px-4 py-1 bg-white dark:bg-gray-800 text-gray-600 text-base rounded-full">
                                Start Date: <span className="font-bold">{row.start_date}</span>
                            </span>
                            <span className="w-full px-4 py-1 bg-white dark:bg-gray-800 text-gray-600 text-base font-bold rounded-full">
                                End Date: <span className="font-bold">{row.end_date}</span>
                            </span>
                        </div>
                    </div>
                );
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal
                ...
                remoteEndPoint='/api/installations/delete'
            ...
            <ArchiveConfirmationModal
                ...
                resourceID={resourceID}
                remoteEndPoint='/api/installations/archive'
            ...
            <CommentsModal
                ...
                commentsEndpoint="/api/installations/comments"
                newCommentEndpoint="/api/installations/comment"
                resourceID={resourceID}
                onClose={closeCommentsModal} />

            <PhotosModal
                isVisible={isPhotosModalVisible}
                photosEndpoint="/api/installations/files"
                newPhotoEndpoint="/api/installations/file"
                resourceID={resourceID}
