...
const Page = () => {
    ...
    const handleUnarchivePopup = (ChangeOrderID) => {
        setResourceID(ChangeOrderID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects/change_orders" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/change_order?archive=true",
    ...
    return (
        <>
            <title>YORK - Change Orders Archive</title>
