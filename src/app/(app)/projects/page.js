...
const Page = () => {
    ...
    const handleArchivePopup = (projectID) => {
        setResourceID(projectID);
    ...
    const actionButtons = (
        <>
            {
                can("Projects - Create") ?
                    <BaseLink href="/projects/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            <BaseButton onClick={async () => { await exportToExcel("projects") }} className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            {
            can("Archive - Create") ?
                <BaseLink href="/projects/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
