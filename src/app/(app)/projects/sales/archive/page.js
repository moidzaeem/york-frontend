...
const Page = () => {
    ...
    const handleUnarchivePopup = (saleID) => {
        setResourceID(saleID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects/sales" className="bg-white md:bg-[#f5f5f5] text-xs md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/sales?archive=true",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        <SimpleIconButton className="border border-gray-600" onClick={ () => handleUnarchivePopup(row.id) } title="Unarchieve">
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
    ...
    return (
        <>
            <title>YORK - Sales Archives</title>
