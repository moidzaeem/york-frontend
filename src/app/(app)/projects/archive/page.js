...
const Page = () => {
    ...
    if (!can(["Projects - View", "Projects - Create", "Projects - Edit", "Projects - Delete"])) {
    ...
    const handlePhotosPopup = (projectID) => {
    ...
    const handleDeletionPopup = (projectID) => {
        setResourceID(projectID);
    ...
    const handleUnarchivePopup = (projectID) => {
        setResourceID(projectID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects" className="bg-white md:bg-[#f5f5f5] text-xl md:text-base" >
    ...
    const tableConfig = {
        remoteURL: "/api/projects?archive=true",
            ...
            },
            {
                ...
                render: (data, row) => {
                    return <ButtonGroupH>
                        ...
                        {
                            can("Projects - Edit") ? 
                                <SimpleIconLink href={`/projects/${row.id}`} className="border border-gray-600" title="Edit">
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                ...
                return (
                    <div 
                        ...
                        <div className="flex flex-col gap-2 w-full mt-4">                            
                            <div className="w-full h-[30px] bg-white rounded-[15px] flex items-center justify-start gap-2 font-bold sm">
                        ...
                        <div className="text-sm text-gray-500 font-light my-4">
                                { row.notes }
                        </div>
    ...
    return (
        <>
            <title>YORK - Projects Archives</title>
            ...
            <DeleteConfirmationModal 
                ...
                remoteEndPoint='/api/projects/delete' 
            ...
            <ArchiveConfirmationModal 
                ...
                resourceID={resourceID} 
                remoteEndPoint='/api/projects/archive' 
            ...
            <CommentsModal
                ...
                commentsEndpoint= "/api/projects/comments"
                newCommentEndpoint= "/api/projects/comment"
                resourceID={ resourceID }
                onClose={ closeCommentsModal } />

            <PhotosModal
                isVisible={ isPhotosModalVisible }
                photosEndpoint= "/api/projects/files"
                newPhotoEndpoint= "/api/projects/file"
                resourceID={ resourceID }
