...
const Page = () => {
    ...
    const handleUnarchivePopup = (punchListID) => {
        setResourceID(punchListID);
    ...
    const actionButtons = (
        <>
            <BaseLink href="/projects/punch_lists" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
    ...
    const breadcrumb = (
        <ul className="flex items-center justify-start gap-3">
            ...
            <li className="capitalize text-base text-gray-500 font-bold">
                Archived Punch Lists
            </li>
        </ul>
    )

    const tableConfig = {
        remoteURL: "/api/punch_list?archive=true",
    ...
    return (
        <>
            <title>YORK - Punch Lists Archive</title>
