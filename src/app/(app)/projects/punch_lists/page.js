...
const Page = () => {
    ...
    if (!can(["Punch Lists - View", "Punch Lists - Create", "Punch Lists - Edit", "Punch Lists - Delete"])) {
    ...
    const handlePhotosPopup = (punchListID) => {
        setResourceID(punchListID);
    ...
    const handleCommentsPopup = (punchListID) => {
        setResourceID(punchListID);
    ...
    const handleDeletionPopup = (punchListID) => {
        setResourceID(punchListID);
    ...
    const handleArchivePopup = (punchListID) => {
        setResourceID(punchListID);
        ...
        <>

            {
                can("Punch Lists - Create") ?
                    <BaseLink href="/projects/punch_lists/new" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
            ...
            <BaseButton onClick={async () => { await exportToExcel("PunchList") }} className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                <Download className="fill-slate-500" />
                Download
            </BaseButton>

            <BaseLink href="/projects/punch_lists/archive" className="bg-white md:bg-[#f5f5f5] text-base md:text-base" >
                    ...
                    return <ButtonGroupH>
...

                        {
                            can("Punch Lists - Edit") ?
                                <SimpleIconLink href={`/projects/punch_lists/${row.id}`} className="border border-gray-600" title="Edit">
                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                    ...
                    <div
                        ...
                        <div className="flex flex-col gap-2 w-full mt-4">
                            ...
                            <div className="w-full h-[30px] bg-white rounded-[15px] flex items-center justify-start gap-2 font-bold text-sm">
                                ...
                                <div className={`grow text-[#939393] ${priorityClass} h-full flex items-center px-1`}>
                                    {row.priority}
                                </div>
                            </div>
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal
                ...
                remoteEndPoint='/api/punch_list/delete'
            ...
            <ArchiveConfirmationModal
                ...
                resourceID={resourceID}
                remoteEndPoint='/api/punch_list/archive'
            ...
            <CommentsModal
                ...
                commentsEndpoint="/api/punch_list/comments"
                newCommentEndpoint="/api/punch_list/comment"
                resourceID={resourceID}
                onClose={closeCommentsModal} />

            <PhotosModal
                isVisible={isPhotosModalVisible}
                photosEndpoint="/api/punch_list/files"
                newPhotoEndpoint="/api/punch_list/file"
                resourceID={resourceID}
