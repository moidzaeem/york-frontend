...
const ArchiveConfirmationModal = ({ isVisible, resourceID = 0, remoteEndPoint="", onClose, datatableRef, children }) => {
                    ...
                    <div className="grid grid-cols-2 gap-2 px-4 py-3 mt-3">
                        {
                            !isSubmitted ? (
                                <>
                                    ...
                                    <BaseButton className="bg-red-500 text-white !w-full lg:!justify-center" onClick={archiveResource}>Yes, proceed</BaseButton>
                                </>
