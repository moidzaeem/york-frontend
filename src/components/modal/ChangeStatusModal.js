...
const ChangeStatusModal = ({ isVisible, resourceID = 0, resourceStatus = "", remoteEndPoint="", onClose, datatableRef, children }) => {
    ...
    const sendRequest = async () => {
        ...
        try {
            await submitData({ id: resourceID, status: resourceStatus });
            ...
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-xl rounded-2xl shadow-teal-200 bg-white">
                <div className="mt-3 w-full">
                    <div className="flex flex-col gap-5">    
                        ...
                        <h3>Are you sure to <strong>change</strong> this resource status?</h3>
