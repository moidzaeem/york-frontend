...
const Header = ({ className = "", isFixed = true, user, children, navigation = "", openSearch = () => {}, responsiveNavigation = "" }) => {
    ...
    return (
        <nav className={`bg-white dark:bg-gray-800 border-b-[1px] border-white dark:border-gray-800 ${ className } ${
            isFixed
                    ...
                    <div className="flex items-center justify-end w-full gap-3">
                        ...
                        <div className="flex items-center">
                            <Dropdown
                                ...
                                trigger={
                                    <button className="grow-0 shrink-0 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-full size-[40px] aspect-square hidden md:flex items-center justify-center">
                                        <Bell size="size-[13px] md:size-[20px]" fill="fill-gray-600 hover:fill-gray-800" />
                                    </button>
                                }>
                                {/* Authentication */} 
